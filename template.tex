...
% Attributions
% ------------
% * fortysecondscv is based on the twentysecondscv class by Carmine Spagnuolo 
...
\documentclass[a4paper, 10pt, showframes]{fortysecondcv}
...
% \RequirePackage[quiet]{fontspec} % use to load font from local folder
...
% pgp key
\cvkey{4096R/FF00FF00}{0xABCDEFGGIJKLMNOP}
...
\addtofrontsidebar{
	...
	\profilesection{Hard Skills}
		\skill{\faAccusoft}{Sleeping almost all day}
	...
	\profilesection{Soft Skills}
		...
		\pointskill{\faCodeBranch}{Chillin' hard}{4}
...
\addtobacksidebar{
	...
	\barskill{\faAccusoft}{Wearing asian rice hats}{60}
...
\begin{cvtable}
	\cvitem{2010}{Cooking like a Panda-Pro: 100 recipes for lazy Pandas}{Panda's
	Culinary World}{}
